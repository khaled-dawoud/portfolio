...
import Resume from "./assets/Khaled_Daowd_Resume.pdf";
...
export const content = {
  ...
  hero: {
    ...
    subtitle: "I'm a React Js Frontend Developer",
    firstName: "KHALED",
    LastName: "DAWOD",
    btnText: "Resume",
    btnLink: Resume,
    ...
    project_content: [
      {
        ...
        github:"https://github.com/khaled-dawoud/Modern-Store",
        details: [
      ...
      },
      {
        ...
        image: project5,
        url: "https://khaled-dawoud.github.io/Creative-Website/",
        github:"https://github.com/khaled-dawoud/Creative-Website",
        details: [
      ...
      },
      {
        ...
        github:"https://github.com/khaled-dawoud/Twitter-Clone-JS-",
        details: [
          "This project was created using HTML CSS for styling.",
          "It utilizes JavaScript for DOM manipulation.",
          "The project follows best practices to create a modern UI.",
  ...
  Hireme: {
    ...
    para: "With years of experience in [insert relevant industry or field], I can help bring your projects to life. Whether you need assistance with [insert examples of project types or tasks], I am dedicated to providing personalized solutions that meet your unique needs and exceed your expectations.",
    btnText: "Hire Me",
  },
  Contact: {
    title: "Contect Me",
    ...
    social_media: [
      ...
      },
      {
        text: "kh_x99x",
        icon: BsInstagram,
        link: "https://www.instagram.com/kh_x99x/",
      },
    ],
  },
  Footer: {
